...
char * mygets(char *,size_t *, FILE *); //ввод из файла строки неограниченной длины, адаптирован для извлечения всех строк с выделением и очисткой памяти внутри этой функции
